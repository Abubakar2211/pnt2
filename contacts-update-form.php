...
if (mysqli_num_rows($query) > 0) {
    ...
    $output .= "<form id='update-form'>
        ...
        <div class='modal-body'>
            ...
            <select class='form-select mb-2' name='contactStatus' id='contactStatus' aria-label='Default select example' required>
                <option value='active'" . ($row['contactStatus'] == 'active' ? ' selected' : '') . ">Active</option>
                <option value='deactive'" . ($row['contactStatus'] == 'deactive' ? ' selected' : '') . ">Deactive</option>
            </select>
            <label for='contactBoardcast'>contact Boardcast</label>
            <select class='form-select mb-2' name='contactBoardcast' id='contactBoardcast' aria-label='Default select example' required>
                <option value='active'" . ($row['contactBoardcast'] == 'active' ? ' selected' : '') . ">Active</option>
                <option value='deactive'" . ($row['contactBoardcast'] == 'deactive' ? ' selected' : '') . ">Deactive</option>
            </select>
        </div>
